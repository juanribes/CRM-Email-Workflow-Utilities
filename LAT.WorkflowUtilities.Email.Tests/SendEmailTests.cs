...
namespace LAT.WorkflowUtilities.Email.Tests
{
    ...
    public class SendEmailTests
    {
        ...
        public SendEmailTests()
        {
            ...
            _namespaceClassAssembly = "LAT.WorkflowUtilities.Email.SendEmail" + ", " + "LAT.WorkflowUtilities.Email";
        }
        #endregion
        ...
        public void SendEmail()
        {
            ...
            //Invoke the workflow
            var output = InvokeWorkflow(_namespaceClassAssembly, ref targetEntity, inputs, SendEmailSetup);

            //Test
            Assert.AreEqual(expected, output["EmailSent"]);
        }
        ...
        private static Mock<IOrganizationService> SendEmailSetup(Mock<IOrganizationService> serviceMock)
        {
